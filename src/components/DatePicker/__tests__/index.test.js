...
describe('DatePicker', () => {
    test('Checking errors in the selected time range and correcting', () => {
        ...
        console.log(RangeComp.find('.uc-fe-datepicker-footer').at(2).html());
        console.log(RangeComp.find('.uc-fe-datepicker-footer').at(3).html());
        console.log(RangeComp.find('.uc-fe-datepicker-footer').at(4).html());
        console.log(RangeComp.find('.uc-fe-datepicker-footer').at(5).html());
        console.log(RangeComp.find('.uc-fe-datepicker-footer').at(6).html());
