...
import { calculateSize, inlineBlockWithVerticalMixin, clearFixMixin } from 'src/style';
...
RangeDateSeparator.defaultProps = {
    theme: defaultTheme
};
