const designTokens = {
    ...
    T_COLOR_BG_CONTENT_1: 'linear-gradient(180deg, #ebedf5 0%, #e3e6f1 100%)',
    ...
    T_COLOR_TEXT_REMARK_LIGHT: '#c3cad9',
    ...
    T_SHADOW_BLOCK_DEFAULT_SM: '0 0 2px 0 #c3cad9, 0 5px 8px -4px #d2d6ea, 0 1px 0 0 #c3cad9',
    T_SHADOW_BLOCK_DEFAULT_MD: '0 0 1px 0 #c3cad9, 0 8px 12px -4px #d2d6ea, 0 4px 4px -2px #c3cad9',
    T_SHADOW_BLOCK_DEFAULT_LG: '0 0 1px 0 #c3cad9, 0 12px 32px -4px #d2d6ea, 0 2px 17px -6px #c3cad9',
    ...
    T_SHADOW_BUTTON_DEFAULT: '0 1px 1px -1px #c3cad9, 0 1px 3px -1px #7a8baa, inset 0 1px 0 0 #efeff8',
    T_SHADOW_BUTTON_HOVER: '0 0 1px 0 #c3cad9, 0 8px 12px -4px #d2d6ea, 0 4px 4px -2px #c3cad9',
...
const transformDesignTokensToTheme = designTokens => {};
