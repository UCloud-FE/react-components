const designTokens = {
    ...
    T_COLOR_BG_CONTENT_1: 'linear-gradient(180deg, #daddea 0%, #DADDEA 100%)',
    ...
    T_PAY_COLOR_BG_1: 'linear-gradient(180deg, #daddea 0%, #DADDEA 100%)',
    ...
    T_SWITCH_COLOR_BG_INNER_ON: '#e6ffed',
    T_SWITCH_COLOR_TEXT_OFF: '#526075',
    T_SWITCH_COLOR_TEXT_ON: '#15ad31',
    T_SWITCH_COLOR_LINE_INNER_ON: '#9effa5',
    T_TABLE_ROW_COLOR_BG_DEFAULT: '#f6f6fb',
    T_TABLE_ROW_COLOR_BG_HOVER: '#F4F6FF',
    T_TABS_DEFAULT_COLOR_BG_DEFAULT: '#daddea',
    ...
    T_WIDTH_MD: '192px',
    T_WIDTH_LG: '320px',
    T_COLOR_BRAND_WHITE: '#ffffff',
    T_COLOR_BRAND_WHITE_TRANSPARENT_70: 'rgba(255,255,255,0.70)',
    T_COLOR_BRAND_BLACK: '#0a1633',
    T_COLOR_BRAND_BLACK_TRANSPARENT_12: 'rgba(10,22,51,0.12)',
    T_COLOR_BRAND_BLACK_TRANSPARENT_20: 'rgba(10,22,51,0.20)',
    T_COLOR_BRAND_TRANSPARENT: 'transparent',
    T_COLOR_BRAND_PRIMARY_1: '#f8f8ff',
    T_COLOR_BRAND_PRIMARY_2: '#F4F6FF',
    T_COLOR_BRAND_PRIMARY_3: '#e3e9ff',
    T_COLOR_BRAND_PRIMARY_6: '#6488fc',
    T_COLOR_BRAND_PRIMARY_7: '#5c76e8',
    T_COLOR_BRAND_PRIMARY_8: '#3860f4',
    T_COLOR_BRAND_PRIMARY_9: '#3357df',
    T_COLOR_BRAND_SECONDARY_1: '#fafafc',
    T_COLOR_BRAND_SECONDARY_2: '#f6f6fb',
    T_COLOR_BRAND_SECONDARY_3: '#efeff8',
    T_COLOR_BRAND_SECONDARY_4: '#dfe0f1',
    T_COLOR_BRAND_SECONDARY_5: '#d2d6ea',
    T_COLOR_BRAND_SECONDARY_6: 'transparent',
    T_COLOR_BRAND_SECONDARY_7: '#c3cad9',
    T_COLOR_BRAND_SECONDARY_8: '#7a8baa',
    T_COLOR_BRAND_SECONDARY_9: '#526075',
    T_COLOR_BRAND_NOTICE_1: '#fafafc',
    T_COLOR_BRAND_NOTICE_2: '#d2d6ea',
    T_COLOR_BRAND_NOTICE_3: '#526075',
    T_COLOR_BRAND_SUCCESS_1: '#e6ffed',
    T_COLOR_BRAND_SUCCESS_2: '#9effa5',
    T_COLOR_BRAND_SUCCESS_3: '#15ad31',
    T_COLOR_BRAND_SUCCESS_4: '#00591c',
    T_COLOR_BRAND_WARNING_1: '#fffce6',
    T_COLOR_BRAND_WARNING_2: '#ffe38d',
    T_COLOR_BRAND_WARNING_3: '#ffc42e',
    T_COLOR_BRAND_WARNING_4: '#ffc42e',
    T_COLOR_BRAND_ERROR_1: '#fff0f0',
    T_COLOR_BRAND_ERROR_2: '#fed4d4',
    T_COLOR_BRAND_ERROR_3: '#f44336',
    T_COLOR_BRAND_ERROR_4: '#5a0c06',
    T_COLOR_BRAND_DISABLED_1: '#f7f7f7',
    T_COLOR_BRAND_DISABLED_2: '#d9d9d9',
    T_COLOR_BRAND_DISABLED_3: '#cccccc',
    ...
    T_COLOR_BRAND_GRADIENT_CONTENT_1_1: '#daddea',
    T_COLOR_BRAND_GRADIENT_CONTENT_1_2: '#DADDEA',
    ...
    T_COLOR_BRAND_GRADIENT_CONTENT_1: 'linear-gradient(180deg, #daddea 0%, #DADDEA 100%)',
    T_COLOR_BRAND_SIDEBAR: '#e7e9f3',
    T_COLOR_BRAND_PURPLE_1: '#f4ebf9',
    T_COLOR_BRAND_PURPLE_2: '#e1ccf0',
    T_COLOR_BRAND_PURPLE_3: '#c6a7e5',
    T_COLOR_BRAND_PURPLE_4: '#af85db',
    T_COLOR_BRAND_PURPLE_5: '#a06dd4',
    T_COLOR_BRAND_PURPLE_6: '#935ecf',
    T_COLOR_BRAND_PURPLE_7: '#6b3aaa',
    T_COLOR_BRAND_PURPLE_8: '#4f298a',
    T_COLOR_BRAND_PURPLE_9: '#322044',
    T_COLOR_BRAND_LIGHTBLUE_1: '#e7f5fd',
    T_COLOR_BRAND_LIGHTBLUE_2: '#c1e9fb',
    T_COLOR_BRAND_LIGHTBLUE_3: '#93e2f8',
    T_COLOR_BRAND_LIGHTBLUE_4: '#6ad7f5',
    T_COLOR_BRAND_LIGHTBLUE_5: '#4dcff4',
    T_COLOR_BRAND_LIGHTBLUE_6: '#3ad0f3',
    T_COLOR_BRAND_LIGHTBLUE_7: '#17b1cd',
    T_COLOR_BRAND_LIGHTBLUE_8: '#0a95a8',
    T_COLOR_BRAND_LIGHTBLUE_9: '#154250',
    T_COLOR_BRAND_BLUE_1: '#e7eefd',
    T_COLOR_BRAND_BLUE_2: '#c1d4fa',
    T_COLOR_BRAND_BLUE_3: '#95bff7',
    T_COLOR_BRAND_BLUE_4: '#6ca7f4',
    T_COLOR_BRAND_BLUE_5: '#4f95f2',
    T_COLOR_BRAND_BLUE_6: '#3c90f0',
    T_COLOR_BRAND_BLUE_7: '#1971cb',
    T_COLOR_BRAND_BLUE_8: '#0c5fa7',
    T_COLOR_BRAND_BLUE_9: '#152d4f',
    T_COLOR_BRAND_ORANGE_1: '#fff5e6',
    T_COLOR_BRAND_ORANGE_2: '#ffe3bd',
    T_COLOR_BRAND_ORANGE_3: '#ffc48d',
    T_COLOR_BRAND_ORANGE_4: '#ffac61',
    T_COLOR_BRAND_ORANGE_5: '#ff9e42',
    T_COLOR_BRAND_ORANGE_6: '#FF8C2E',
    T_COLOR_BRAND_ORANGE_7: '#d9610b',
    T_COLOR_BRAND_ORANGE_8: '#B34400',
    T_COLOR_BRAND_ORANGE_9: '#543211',
    T_COLOR_BRAND_YELLOW_1: '#fffce6',
    T_COLOR_BRAND_YELLOW_2: '#fff5bd',
    T_COLOR_BRAND_YELLOW_3: '#ffe38d',
    T_COLOR_BRAND_YELLOW_4: '#FFD761',
    T_COLOR_BRAND_YELLOW_5: '#ffd042',
    T_COLOR_BRAND_YELLOW_6: '#ffc42e',
    T_COLOR_BRAND_YELLOW_7: '#d9980b',
    T_COLOR_BRAND_YELLOW_8: '#b37400',
    T_COLOR_BRAND_YELLOW_9: '#544411',
    T_COLOR_BRAND_CYAN_1: '#e8fcfc',
    T_COLOR_BRAND_CYAN_2: '#c3f8f5',
    T_COLOR_BRAND_CYAN_3: '#98f3e5',
    T_COLOR_BRAND_CYAN_4: '#70efdb',
    T_COLOR_BRAND_CYAN_5: '#55ecd6',
    T_COLOR_BRAND_CYAN_6: '#43eacb',
    T_COLOR_BRAND_CYAN_7: '#1fc4a1',
    T_COLOR_BRAND_CYAN_8: '#12a17d',
    T_COLOR_BRAND_CYAN_9: '#174d45',
    T_COLOR_BRAND_RED_1: '#fff0f0',
    T_COLOR_BRAND_RED_2: '#ffe2e2',
    T_COLOR_BRAND_RED_3: '#fed4d4',
    T_COLOR_BRAND_RED_4: '#FBA49F',
    T_COLOR_BRAND_RED_5: '#F7736B',
    T_COLOR_BRAND_RED_6: '#f44336',
    T_COLOR_BRAND_RED_7: '#C13126',
    T_COLOR_BRAND_RED_8: '#8D1E16',
    T_COLOR_BRAND_RED_9: '#5a0c06',
    T_COLOR_BRAND_GREEN_1: '#E6FFED',
    T_COLOR_BRAND_GREEN_2: '#C2FFC9',
    T_COLOR_BRAND_GREEN_3: '#9EFFA5',
    T_COLOR_BRAND_GREEN_4: '#70E47E',
    T_COLOR_BRAND_GREEN_5: '#43C858',
    T_COLOR_BRAND_GREEN_6: '#15AD31',
    T_COLOR_BRAND_GREEN_7: '#0E912A',
    T_COLOR_BRAND_GREEN_8: '#077523',
    T_COLOR_BRAND_GREEN_9: '#00591C',
    T_COLOR_BRAND_SYSTEM_WHITE: '#ffffff',
    T_COLOR_BRAND_SYSTEM_WHITE_TRANSPARENT_5: 'rgba(255,255,255,0.05)',
    T_COLOR_BRAND_SYSTEM_WHITE_TRANSPARENT_8: 'rgba(255,255,255,0.08)',
    T_COLOR_BRAND_SYSTEM_WHITE_TRANSPARENT_12: 'rgba(255,255,255,0.12)',
    T_COLOR_BRAND_SYSTEM_WHITE_TRANSPARENT_30: 'rgba(255,255,255,0.30)',
    T_COLOR_BRAND_SYSTEM_WHITE_TRANSPARENT_50: 'rgba(255,255,255,0.50)',
    T_COLOR_BRAND_SYSTEM_WHITE_TRANSPARENT_70: 'rgba(255,255,255,0.7)',
    T_COLOR_BRAND_SYSTEM_BLACK: '#000000',
    T_COLOR_BRAND_SYSTEM_BLACK_TRANSPARENT_5: 'rgba(0,0,0,0.05)',
    T_COLOR_BRAND_SYSTEM_BLACK_TRANSPARENT_8: 'rgba(0,0,0,0.08)',
    T_COLOR_BRAND_SYSTEM_BLACK_TRANSPARENT_12: 'rgba(0,0,0,0.12)',
    T_COLOR_BRAND_SYSTEM_BLACK_TRANSPARENT_30: 'rgba(0,0,0,0.30)',
    T_COLOR_BRAND_SYSTEM_BLACK_TRANSPARENT_50: 'rgba(0,0,0,0.50)',
    T_COLOR_BRAND_SYSTEM_BLACK_TRANSPARENT_70: 'rgba(0,0,0,0.7)',
